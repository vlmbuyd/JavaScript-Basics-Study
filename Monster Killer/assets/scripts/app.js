...
function wrtieToLog(ev, val, monsterHealth, playerHealth) {
  let logEntry = {
    event: ev,
    value: val,
  ...
  switch (ev) {
    case LOG_EVENT_PLAYER_ATTACK:
      logEntry.target = "MONSTER"; //새로운 속성 추가
      break;
...
function attackMonster(mode) {
  ...
  wrtieToLog(logEvent, damage, currentMonsterHealth, currentPlayerHealth);
  endRound();
}
